...
if __name__=="__main__":
	...
	if scraped_data:
		print("Writing scraped data to %s-%s-%s-yellowpages-scraped-data.csv"%(keyword,place,page))
		with open('%s-%s-yellowpages-scraped-data.csv'%(keyword,place),'ab') as csvfile:
